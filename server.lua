...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientpistol_extendedclip', function(source, cb)
    local src = source
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientpistol_suppressor', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientpistol_part_trigger', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientpistol_part_stock', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientpistol_part_mag', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_part_trigger', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
----
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_part_stock', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_part_mag', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientrifle_extendedclip', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_flashlight', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_scope', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientweapon_compactrifle', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientweapon_smg', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientrifle_part_trigger', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientrifle_part_stock', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
--
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientrifle_part_mag', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientweapon_pumpshotgun', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientshotgun_ammo', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientsmg_ammo', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
...
---
QBCore.Functions.CreateCallback('raj-guncrafting:server:ingredientrifle_ammo', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local metalscrap = Player.Functions.GetItemByName("metalscrap")
    local steel = Player.Functions.GetItemByName("steel")
